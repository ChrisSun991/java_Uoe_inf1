abstract class Buffer {
     ...
     * The capacity must be larger or equal to two, otherwise an exception is thrown.
     */
    public Buffer(int capacity) {
        if(capacity < 2)
            throw new IllegalArgumentException("The given buffer capacity must be larger or equal to two.");
